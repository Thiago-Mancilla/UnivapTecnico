            ...
            if codigo_paciente == 0:
                ...
                if Pacientes.consultarPaciente(codigo_paciente) != 0:
                    ...
                    if op == 'A':
                        ...
                        if confirma == "S":
                            categoria = "Pacientes"
                            if (Consultas.consultarConsultaByNome(codigo_paciente, categoria) == 0):
                                Pacientes.deletarPaciente(codigo_paciente)
                                print("Excluído com sucesso!")
                            else: 
                                print("Verifique se Paciente não está relacionado com uma consulta!")
                        elif confirma == "N":
            ...
            if codigo_medico == 0:
                ...
                if Medicos.consultarMedico(codigo_medico) != 0:
                    ...
                    if op == 'A':
                        ...
                        if confirma == "S":
                            categoria = "Medicos"
                            if (Consultas.consultarConsultaByNome(codigo_medico, categoria) == 0):
                                Medicos.deletarMedico(codigo_medico)
                                print("Excluído com sucesso!")
                            else: 
                                print("Verifique se Medico não está relacionado com uma consulta!")
                        elif confirma == "N":
                            print("Exclusão cancelada!")
                else:
